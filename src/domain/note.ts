 ...
 */
export function buildNote(input: NoteInput, fallbackTitle = DEFAULT_NOTE_TITLE): Note {
 ...
 */
export function deriveTitleFromPath(path: string, fallback = DEFAULT_NOTE_TITLE): string {
